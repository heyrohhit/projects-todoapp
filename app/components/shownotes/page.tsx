  ...
  return (
    <div className="w-full p-6 overflow-x-hidden">
      ...
      <div className="flex gap-6 flex-wrap-reverse justify-center items-center">
        {notes.length == 0 ?
        <h3 className="text-gray-400 capitalize flex justify-center items-center w-full h-[50vh]">not any notes yet....</h3>
        :notes.map((note,index) => (
          <div key={index} className="p-5 rounded-2xl shadow-lg ">
            ...
            <p className="text-white-600 mb-3 whitespace-break-spaces">{note.msg}</p>
